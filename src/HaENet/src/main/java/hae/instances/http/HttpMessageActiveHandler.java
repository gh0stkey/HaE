...
public class HttpMessageActiveHandler implements HttpHandler {
    ...
    public ResponseReceivedAction handleHttpResponseReceived(HttpResponseReceived httpResponseReceived) {
        ...
        if (!matches) {
            try {
                setColorAndCommentList(messageProcessor.processRequest(host.get(), request.url(), request, true, true));
                setColorAndCommentList(messageProcessor.processResponse(host.get(), request.url(), httpResponseReceived, true, true));
